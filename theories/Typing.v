...
Inductive pos_arg (Σ : global_context) (Γ : ienv) : term -> Set :=
| pos_arg_prod na b d :
...
Inductive pos_constructor (Σ : global_context) (Γ : ienv) : term -> Set :=
...
| pos_ind_cons na ty cstrs projs kelim l :
    ...
    pos_inddecls Σ Γ l ->
    pos_inddecls Σ Γ (mkinductive_body na ty kelim cstrs projs :: l).

Definition init_ienv (inds : minductive_decl) :=
  (** FIXME: same as below *)
...
Definition type_inductive Σ inds : Set :=
